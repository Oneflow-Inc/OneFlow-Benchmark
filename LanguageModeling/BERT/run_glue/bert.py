  ...
  with flow.deprecated.variable_scope("layer_%d" % layer_idx):
    ...
    with flow.deprecated.variable_scope("attention"):
      ...
      with flow.deprecated.variable_scope("output"):
        ...
        attention_output_blob = _LayerNorm(attention_output_blob, hidden_size,trainable=trainable)
    ...
    with flow.deprecated.variable_scope("output"):
      ...
      layer_output_blob = _LayerNorm(layer_output_blob, hidden_size,trainable=trainable)
