...
def parse_args():
    ...
    parser.add_argument("--weight_decay_rate", type=float,
                        default=0.01, help="weight l2 decay parameter")
    ...
    parser.add_argument("--skip_iter_num", type=int, default=0,
    ...
    parser.add_argument("--data_part_num", type=int,
                        default=32, help="data part number in dataset")
    parser.add_argument("--enable_auto_mixed_precision",
