...
#
#     def __init__(self, input_ids, attention_mask, token_type_ids, task: int, label,
#                  logits=None, meta: Optional[Dict] = None, idx=-1):
#         """
...
#
#
# # def trim_input_ids(input_ids, pad_token_id, mask_token_id, num_masks: int):
# #     """
