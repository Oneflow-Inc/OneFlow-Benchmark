...
mkdir -p $LOG_FOLDER
LOG_FILENAME=$LOG_FOLDER/${TRAN_MODEL}_${RUN_TIME}_${NUM_NODES}n${NUM_GPUS_PER_NODE}g_b${BATCH_SIZE}_fp16${USE_FP16}_training_iter${ITER_NUM}.log
...
LEARNING_RATE=$(($NUM_NODES*$NUM_GPUS_PER_NODE*$BATCH_SIZE/1000))
