...
def resnext34(images, trainable=True, training=True,
        channel_last=False, **kwargs):
...
def resnext50(images, trainable=True, training=True,
        channel_last=False, **kwargs):
...
def resnext101(images, trainable=True, training=True,
        channel_last=False, **kwargs):
...
def resnext152(images, trainable=True, training=True,
        channel_last=False, **kwargs):
