...
def get_parser(parser=None):
    ...
    parser.add_argument("--model", type=str, default="resnet50", help="resnet50")
    parser.add_argument(
        "--use_fp16",
        type=str2bool,
        nargs="?",
    ...
    # inference
    parser.add_argument(
        "--image_path", type=str, default="test_img/tiger.jpg", help="image path"
    )
    ...
    parser.add_argument(
        "--num_examples", type=int, default=1281167, help="train pic number"
    )
    parser.add_argument(
        "--num_val_examples", type=int, default=50000, help="validation pic number"
    )
    parser.add_argument(
        "--rgb-mean",
        type=float_list,
