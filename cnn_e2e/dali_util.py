...
def add_dali_args(parser):
    ...
    group.add_argument('--image-shape', type=int_list, default=[3, 224, 224],
                        help='the image shape feed into the network') 

    group.add_argument('--data_train', type=str, help='the training data')
    group.add_argument('--data_train_idx', type=str, default='', help='the index of training data')
    group.add_argument('--data_val', type=str, help='the validation data')
    group.add_argument('--data_val_idx', type=str, default='', help='the index of validation data')
