    ...
    def build_network(self, input_data, need_transpose, data_format, class_num=1000, prefix="", **configs):
        ...
        for i, layer_setting in enumerate(self.config_map['bottleneck_params_list']):
            ...
            if i == 0:
                ...
                in_c = int(round(c*self.multiplier))
        print("last_bottleneck_layer shape", last_bottleneck_layer.shape)
        ...
        print("pool in shape", last_fm.shape)
...
def Mobilenet(input_data, need_transpose, data_format="NCHW", num_classes=1000, multiplier=1.0, prefix = ""):
