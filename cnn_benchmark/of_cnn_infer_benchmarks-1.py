...
# train
parser.add_argument(
    "--model", type=str, default="resnet50", required=False, help="vgg16 or resnet50"
)
parser.add_argument("--batch_size_per_device", type=int, default=50, required=False)
parser.add_argument(
    "--iter_num", type=int, default=500, required=False, help="total iterations to run"
)
parser.add_argument(
    "--warmup_iter_num",
    type=int,
